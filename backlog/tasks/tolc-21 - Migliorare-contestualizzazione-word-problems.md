...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Almeno 6 nuovi contesti realistici aggiunti ai template esistenti (es. spesa, viaggi, abbonamenti, sport, cucina, bollette)
- [ ] #2 I contesti sono culturalmente appropriati per studenti italiani (prezzi in euro, riferimenti locali)
- [ ] #3 La struttura matematica sottostante rimane invariata — cambiano solo i 'vestiti' del problema
- [ ] #4 Ogni livello di difficoltà ha almeno 2 contesti nuovi
- [ ] #5 I testi sono grammaticalmente corretti in italiano
- [ ] #6 Test pytest verifica che i nuovi contesti generano correttamente
- [ ] #7 Aggiornare `claudedocs/tolc-b-coverage-analysis.md`: spuntare R9 in sezione 4, aggiungere riga al Registro Modifiche
<!-- AC:END -->
